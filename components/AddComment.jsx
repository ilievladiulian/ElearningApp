        ...
        return (
            <div>
                {this.state.comment.map((comment, i) =>
                    <Comments key={i} commentsDescription={comment.description} commentsDate={comment.date}
                              commentsAuthor={comment.author} commentsAuthorType={comment.authorType}/>
                )}
                {this.props.authorType == 'student' ? (
                    <div className="panel panel-info">
                        ...
                        <div className="panel-body">
                            ...
                            <button type="button" className="btn btn-block btn-info" onClick={this.setStateHandler}>
                                Reply
                            </button>
                        </div>
                    </div>
                    ...
                    <div className="panel panel-success">
                        ...
                        <div className="panel-body">
                            ...
                            <button type="button" className="btn btn-block btn-success" onClick={this.setStateHandler}>
                                Reply
                            </button>
                        </div>
                    </div>
